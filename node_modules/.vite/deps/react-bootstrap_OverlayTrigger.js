...
import {
  Popover_default
} from "./chunk-CDKM3SBH.js";
import "./chunk-6FWUWXAQ.js";
import {
  require_classnames,
  require_jsx_runtime,
  useBootstrapPrefix
...
var Overlay = React2.forwardRef((props, outerRef) => {
  ...
  if (Transition2) {
    ...
    child = (0, import_jsx_runtime.jsx)(Transition2, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react18.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var TransitionWrapper = import_react21.default.forwardRef((_a, ref) => {
  var _b = _a, {
    onEnter,
    onEntering,
    onEntered,
...
var Overlay2 = React7.forwardRef((_a, outerRef) => {
  var _b = _a, {
    children: overlay,
    transition,
    popperConfig = {}
  ...
  return (0, import_jsx_runtime4.jsx)(Overlay_default, __spreadProps(__spreadValues({}, outerProps), {
    ref: mergedRef,
    ...
    children: (overlayProps, {
      ...
      return React7.cloneElement(overlay, __spreadProps(__spreadValues({}, overlayProps), {
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
function OverlayTrigger(_a) {
  ...
  return (0, import_jsx_runtime7.jsxs)(import_jsx_runtime6.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react24.cloneElement)(children, triggerProps), (0, import_jsx_runtime5.jsx)(Overlay_default2, __spreadProps(__spreadValues({}, props), {
      show,
      onHide: handleHide,
      flip: flip2,
      placement,
...
// dep:react-bootstrap_OverlayTrigger
var react_bootstrap_OverlayTrigger_default = OverlayTrigger_default;
export {
  react_bootstrap_OverlayTrigger_default as default
};
