...
var Col = React9.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Component, __spreadProps(__spreadValues({}, colProps), {
    ref,
...
var FormLabel = React10.forwardRef((_a, ref) => {
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime10.jsx)(Col_default, __spreadValues({
      ref,
      as: "label",
      className: classes,
      htmlFor
    }, props));
  return (0, import_jsx_runtime10.jsx)(Component, __spreadValues({
    ref,
    className: classes,
    htmlFor
  }, props));
...
var FormRange = React11.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    id
  ...
  return (0, import_jsx_runtime11.jsx)("input", __spreadProps(__spreadValues({}, props), {
    type: "range",
    ref,
...
var FormSelect = React12.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    size,
    htmlSize,
  ...
  return (0, import_jsx_runtime12.jsx)("select", __spreadProps(__spreadValues({}, props), {
    size: htmlSize,
    ref,
...
var FormText = React13.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    as: Component = "small",
  ...
  return (0, import_jsx_runtime13.jsx)(Component, __spreadProps(__spreadValues({}, props), {
    ref,
...
var Switch = React14.forwardRef((props, ref) => (0, import_jsx_runtime14.jsx)(FormCheck_default, __spreadProps(__spreadValues({}, props), {
  ref,
  type: "switch"
})));
...
var Form = React16.forwardRef((_a, ref) => {
  var _b = _a, {
    className,
    validated,
    as: Component = "form"
  ...
  return (0, import_jsx_runtime17.jsx)(Component, __spreadProps(__spreadValues({}, props), {
    ref,
